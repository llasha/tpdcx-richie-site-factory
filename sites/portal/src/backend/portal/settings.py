"""
Django settings for the richie portal project.
"""
...
class Production(Base):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "production-portal-tpdcx-richie-media"
    )
...
class Feature(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "feature-portal-tpdcx-richie-media"
    )
...
class Staging(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "staging-portal-tpdcx-richie-media"
    )
...
class PreProduction(Production):
    ...
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "preprod-portal-tpdcx-richie-media"
    )
